...
if(!class_exists('Serbian_Transliteration__Plugin__woocommerce')) :
	class Serbian_Transliteration__Plugin__woocommerce extends Serbian_Transliteration
	{
		...
		public static function run() {
			global $rstr_cache;
			if ( !$rstr_cache->get('Serbian_Transliteration__Plugin__woocommerce') ) {
				$rstr_cache->set('Serbian_Transliteration__Plugin__woocommerce', new self());
			}
			return $rstr_cache->get('Serbian_Transliteration__Plugin__woocommerce');
		}
