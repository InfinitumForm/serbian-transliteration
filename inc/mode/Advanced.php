...
if(!class_exists('Serbian_Transliteration_Mode_Advanced')) :
	class Serbian_Transliteration_Mode_Advanced extends Serbian_Transliteration
	{
		...
		public static function run() {
			global $rstr_cache;
			if ( !$rstr_cache->get('Serbian_Transliteration_Mode_Advanced') ) {
				$rstr_cache->set('Serbian_Transliteration_Mode_Advanced', new self());
			}
			return $rstr_cache->get('Serbian_Transliteration_Mode_Advanced');
		} 
